...
const sameOrigin = withoutTrailingSlash(window.location.origin)
const development = import.meta.env.DEV

const webURL = withoutTrailingSlash(import.meta.env.VITE_WEB_URL || sameOrigin)
const baseURL = withoutTrailingSlash(
  import.meta.env.VITE_API_BASE_URL || (development ? 'http://localhost:8081' : `${sameOrigin}/api`)
)
const imBaseURL = withoutTrailingSlash(
  import.meta.env.VITE_IM_BASE_URL || (development ? 'http://localhost:81/im' : `${sameOrigin}/im`)
)
...
export default {
  ...
  live2d_path: "https://fastly.jsdelivr.net/npm/live2d-widgets@1.0.1/dist/",
  ...
  friendIntroduction: "这是一个 Vue 3、Vite 与 Spring Boot 结合的产物～",
