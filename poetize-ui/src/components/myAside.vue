    ...
    <div class="myAside-container">
      ...
      <div v-if="!$common.mobile()" class="card-content1 shadow-box background-opacity">
        ...
        <a class="collection-btn" @click="showTip()">
          <el-icon style="margin-right: 2px"><component :is="$icons.Star" /></el-icon>朋友圈
        </a>
      </div>
      ...
      <div v-if="!$common.isEmpty(recommendArticles)"
        ...
        <div v-for="(article, index) in recommendArticles"
          ...
          <div class="aside-post-date">
            <el-icon style="color: var(--greyFont)"><component :is="$icons.Calendar" /></el-icon>{{ article.createTime }}
          </div>
        </div>
      </div>
      ...
      <div class="shadow-box background-opacity"
        ...
        <div class="card-content2-title">
          <el-icon class="card-content2-icon"><component :is="$icons.FolderOpened" /></el-icon>
          <span>分类</span>
        </div>
        <div v-for="(sort, index) in sortInfo"
             :key="index"
      ...
      <div class="shadow-box-mini background-opacity admire-box"
        ...
        <div>
          <Vue3SeamlessScroll :list="admires" style="height: 200px;overflow: hidden">
