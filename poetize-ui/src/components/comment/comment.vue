  ...
  <div>
    ...
    <div style="margin-bottom: 40px">
      <div class="comment-head">
        <el-icon style="font-weight: bold;font-size: 22px;"><component :is="$icons.EditPen" /></el-icon> 留言
      </div>
      <div>
        <!-- 文字评论 -->
...
<script>
  ...
  export default {
    ...
    methods: {
            ...
            if (!this.$common.isEmpty(res.data) && !this.$common.isEmpty(res.data.records)) {
              if (this.$common.isEmpty(floorComment)) {
                ...
                if (isToPage === false) {
                  ...
                  this.emoji(res.data.records, false);
      ...
      submitComment(commentContent, finish = () => {}) {
        let comment = {
          source: this.source,
          type: this.type,
      ...
      submitReply(commentContent, finish = () => {}) {
        let comment = {
          source: this.source,
          type: this.type,
