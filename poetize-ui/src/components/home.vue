              ...
              <el-dropdown placement="bottom">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item @click="logout()" v-if="!$common.isEmpty($store.state.currentUser)">
    ...
    <div class="toolButton">
      ...
      <el-popover placement="left"
        ...
        <div class="my-setting">
          <div>
            <!-- 太阳按钮 -->
            <el-icon v-if="isDark" class="iconRotate" @click="changeColor()"><component :is="$icons.Sunny" /></el-icon>
            <!-- 月亮按钮 -->
  ...
  export default {
    data() {
      return {
        ...
        toolbarDrawer: false,
        mobile: false,
        mouseAnimationCleanup: null
      }
    },
    mounted() {
      if (this.mouseAnimation) {
        this.mouseAnimationCleanup = mousedown();
      }
    ...
    methods: {
      ...
      goAdmin() {
        window.open(this.$constant.webURL + "/admin", "_blank", "noopener,noreferrer");
      },
      ...
      buildCssPicture() {
        ...
        if (this.$common.isEmpty(webStaticResourcePrefix)) {
          return;
        }
      ...
      changeMouseAnimation() {
        ...
        if (this.mouseAnimation) {
          ...
          this.mouseAnimationCleanup?.();
          this.mouseAnimationCleanup = null;
        }
      }
    }
  }
