  ...
  <div>
    <div>
      <div class="handle-box">
        ...
        <el-button type="primary" :icon="$icons.Search" @click="searchUser()">搜索</el-button>
      ...
      <el-table :data="users" border class="table" header-cell-class-name="table-header">
        ...
        <el-table-column label="赞赏" width="100" align="center">
          <template #default="scope">
            <el-input size="default" maxlength="30" v-model="scope.row.admire"
        ...
        <el-table-column label="用户状态" align="center">
          <template #default="scope">
            ...
            <el-switch v-if="scope.row.id !== $store.state.currentAdmin.id" @change="changeUserStatus(scope.row)" v-model="scope.row.userStatus"></el-switch>
          </template>
        </el-table-column>
