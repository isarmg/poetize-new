<template>
  <div>
    <div class="handle-box">
      ...
      <el-button type="primary" :icon="$icons.Search" @click="searchArticles()">搜索</el-button>
    ...
    <el-table :data="articles" border class="table" header-cell-class-name="table-header">
      ...
      <el-table-column label="是否可见" align="center">
        <template #default="scope">
          ...
          <el-switch @change="changeStatus(scope.row, 1)" v-model="scope.row.viewStatus"></el-switch>
        </template>
      </el-table-column>
      ...
      <el-table-column label="是否启用评论" align="center">
        <template #default="scope">
          ...
          <el-switch @change="changeStatus(scope.row, 2)" v-model="scope.row.commentStatus"></el-switch>
        </template>
      </el-table-column>
      <el-table-column label="是否推荐" align="center">
        <template #default="scope">
          ...
          <el-switch @change="changeStatus(scope.row, 3)" v-model="scope.row.recommendStatus"></el-switch>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="180" align="center">
        <template #default="scope">
          <el-button link :icon="$icons.Edit" @click="handleEdit(scope.row)">编辑</el-button>
          <el-button link :icon="$icons.Delete" style="color: var(--orangeRed)" @click="handleDelete(scope.row)">
            删除
          </el-button>
        </template>
      </el-table-column>
