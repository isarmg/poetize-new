...
public class CommonConst {
    ...
    public static final String ARTICLE_PASSWORD_FAILURE = "article_password_failure_";
    public static final int ARTICLE_PASSWORD_FAILURE_LIMIT = 10;
    public static final long ARTICLE_PASSWORD_FAILURE_EXPIRE = 900;
