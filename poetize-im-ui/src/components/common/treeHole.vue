<template>
  <div class="tree-hole-container">
    ...
    <div class="tree-hole-go">
      <button type="button" class="tree-hole-launch" aria-label="发布随笔" @click="launch()">
        <svg viewBox="0 0 1024 1024" width="25" height="25" aria-hidden="true">
          <path d="M928 96 96 432l310 124 124 310L928 96zM453 522l307-276-255 318-52-42z" fill="currentColor"/>
        </svg>
      </button>
    </div>
  </div>
